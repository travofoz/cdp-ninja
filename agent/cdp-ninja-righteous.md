...
### Session Management
- **Parent session**: Main security conversation
- **Child sessions**: Deep-dive security analysis
- **Navigation**: Ctrl+Left/Right between security specialties
- **Context preservation**: Security context and protection state

### Command Integration
- **@cdp-ninja-righteous** → Direct security analysis
- **/debug-cdp** → Hidden Door routes here for security issues
- **Tab switching** → Move to Build agent for security fixes
- **Session history** → Maintain security investigation context

The Righteous school brings unparalleled security guardianship to the CDP Ninja system, protecting systems and users with unwavering moral conviction and ethical precision, ensuring digital integrity through comprehensive security analysis and protective vigilance.