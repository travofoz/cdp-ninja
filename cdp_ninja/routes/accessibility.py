...
from cdp_ninja.templates.accessibility_js import AccessibilityJSTemplates
...
def accessibility_audit():
    ...
    try:
        ...
        try:
            ...
            # Use template for accessibility audit
            audit_js = AccessibilityJSTemplates.accessibility_audit_template(
...
def keyboard_navigation():
    ...
    try:
        ...
        try:
            ...
            keyboard_test_js = AccessibilityJSTemplates.keyboard_navigation_template()
...
def screen_reader_simulation():
    ...
    try:
        ...
        try:
            ...
            screen_reader_js = AccessibilityJSTemplates.screen_reader_simulation_template()
